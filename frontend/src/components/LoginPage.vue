    ...
    <div class="login-card" :class="{ 'fade-in': mounted }">
      ...
      <form v-if="activeTab === 'login'" @submit.prevent="handleLogin" class="login-form">
        <div class="input-group">
          ...
          <input v-model="loginForm.email" type="email" placeholder="邮箱地址" required />
        </div>
        ...
        <div class="input-group">
          ...
          <input v-model="loginForm.password" :type="showPassword ? 'text' : 'password'" placeholder="密码" required />
